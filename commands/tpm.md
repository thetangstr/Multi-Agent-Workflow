...
1. FETCH all active project issues from Linear
   -> mcp__linear__list_issues (team: "{{TEAM_NAME}}")
...
|-------|-------|-------|----|---------------|
| {{ISSUE_PREFIX}}-101 | Add user schema | shipped | #42 | -- |
| {{ISSUE_PREFIX}}-102 | Create endpoints | awaiting-human | #43 | Verify externals |
| {{ISSUE_PREFIX}}-103 | Build profile UI | building | #44 | -- |
...
- Shipped {{ISSUE_PREFIX}}-101 to production (smoke tests passed)

### Human Action Required
1. **Verify {{ISSUE_PREFIX}}-102** -> add `Human-Verified` label
2. **Investigate {{ISSUE_PREFIX}}-105** -- Tests-Failed 2x, auto-fix exhausted
```
...
**Step 1: Find the PR**
```bash
gh pr list --search "{{ISSUE_PREFIX}}-<number>" --state open --json number,title,headRefName,baseRefName
```
...
gh pr create --base main --title "{{ISSUE_PREFIX}}-<number>: <title> [production]" --body "Production PR. Staging-verified and Human-Verified."
```
...
### Shipped This Sync
- {{ISSUE_PREFIX}}-101: <title> (smoke passed)

### Awaiting Human
- {{ISSUE_PREFIX}}-102: <title> (Locally-Tested, needs Human-Verified)

### Blocked
- {{ISSUE_PREFIX}}-105: <title> (Tests-Failed 2x, escalated)
...
|-------|-------|------|-------|----|
| {{ISSUE_PREFIX}}-101 | ... | M | building | #42 |
| {{ISSUE_PREFIX}}-102 | ... | S | testing | #43 |

### Dependencies
{{ISSUE_PREFIX}}-103 (Wave 2) is waiting on: {{ISSUE_PREFIX}}-101, {{ISSUE_PREFIX}}-102
```
...
| State | Count | Issues |
|-------|-------|--------|
| shipped | 3 | {{ISSUE_PREFIX}}-101, {{ISSUE_PREFIX}}-102, {{ISSUE_PREFIX}}-103 |
| awaiting-human | 1 | {{ISSUE_PREFIX}}-104 |
| testing | 2 | {{ISSUE_PREFIX}}-105, {{ISSUE_PREFIX}}-106 |
| building | 1 | {{ISSUE_PREFIX}}-107 |
| queued | 2 | {{ISSUE_PREFIX}}-108, {{ISSUE_PREFIX}}-109 |
| blocked | 0 | -- |
