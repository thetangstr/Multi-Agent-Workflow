...
|---------|-------|-------------|
| `/workon {{ISSUE_PREFIX}}-XXX` | Orchestrator | Drive issue from intake -> locally-tested |
...
| `/builder {{ISSUE_PREFIX}}-XXX` | Builder | Work on specific issue |
| `/tester {{ISSUE_PREFIX}}-XXX` | Tester | Test specific issue |
...
| Task | Command | Notes |
|------|---------|-------|
| **Start any issue** | `/workon {{ISSUE_PREFIX}}-XXX` | Per-workspace orchestration |
...
| Start implementation | `/builder {{ISSUE_PREFIX}}-XXX` | Skip PM, go direct |
| Test a PR | `/tester {{ISSUE_PREFIX}}-XXX` | Manual test trigger |
